package com.ricardofernandezv.blog.config;

import com.ricardofernandezv.blog.domain.entities.User;
import com.ricardofernandezv.blog.repositories.UserRepository;
import com.ricardofernandezv.blog.security.BlogUserDetailsService;
import com.ricardofernandezv.blog.security.JwtAuthenticationFilter;
...
//        return new BlogUserDetailsService(userRepository);
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.List.of(
                "http://localhost:4200",
                "https://blogix-frontend.vercel.app"
        ));
